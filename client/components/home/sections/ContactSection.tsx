...
export default function ContactSection() {
  const contactMethods = [
    {
      icon: <Mail className="w-8 h-8 text-blue-500 mx-auto mb-4" />,
      title: "Email Us",
    ...
    {
      icon: <Phone className="w-8 h-8 text-green-500 mx-auto mb-4" />,
      title: "Call Us",
    ...
    {
      icon: <MapPin className="w-8 h-8 text-red-500 mx-auto mb-4" />,
      title: "Visit Us",
    ...
    {
      icon: <MessageCircle className="w-8 h-8 text-purple-500 mx-auto mb-4" />,
      title: "Live Chat",
